                ...
                <div className='row'>
                    ...
                    <div className='col-12 col-md-7' style={{ borderLeft: '1px solid black' }}>
                        <div className='ms-md-5'>
                            ...
                            <ul>
                                <li className='title-text fw-bold'>Expertise and Experience</li>
                            </ul>
                            ...
                            <ul>
                                <li className='title-text fw-bold'>Client-Centric Approach</li>
                            </ul>
                            <p className='text-secondary' >
                                <ul>
                            ...
                            <ul>
                                <li className='title-text fw-bold'>Quality and Reliability</li>
                            </ul>
                            <p className='text-secondary' >
                                <ul>
                            ...
                            <ul>
                                <li className='title-text fw-bold'>Innovation and Future-Forward Thinking</li>
                            </ul>
                            ...
                            <ul>
                                <li className='title-text fw-bold'>Passion and Dedication</li>
                            </ul>
                            <p className='text-secondary' >
                                <ul>
                            ...
                            <ul>
                                <li className='title-text fw-bold'>IT Consulting & Support</li>
                            </ul>
                            <p className='text-secondary' >
                                <ul>
                            ...
                            <ul>
                                <li className='title-text fw-bold'>Agile and Flexible Approach</li>
                            </ul>
                            <p className='text-secondary' >
                                <ul>
                            ...
                            <ul>
                                <li className='title-text fw-bold'> Cost-Effectiveness</li>
                            </ul>
                            <p className='text-secondary' >
                                <ul>
